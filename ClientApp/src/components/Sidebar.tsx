      ...
      <ul id="rooms-list">
        {rooms.map((room, i) => (
          <li
            ...
            onClick={() => { onRoomClick(room.id, room.name); onClose() }}
          >
            <span className="room-icon">{room.icon}</span>
            <span className="room-name">{room.name}</span>
            {room.memberCount ? <span className="room-count">{room.memberCount}</span> : null}
          </li>
        ))}
      </ul>
      ...
      <div className="sidebar-bottom">
        ...
        {user && (
          <div className="sidebar-user">
            <span className="user-avatar" style={{ background: nameToColor(user.userName) }}>
